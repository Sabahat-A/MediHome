...
<p id="h11" class="h3 d-flex justify-content-center m-0 p-0"> PAYMENT DETAILS</p>
</div> </div>
...
include 'config.php';
 $n=1;
$sql="select * from payment   where ShopName='$ShopName'  ORDER BY PID ";
...
<td>
 <a href='UpdatePayMent.php?id=<?php echo $row['PID']; ?>' data-bs-toggle="tooltip" title="Update" data-bs-placement="bottom"><i class=" fa fas fa-edit " id="u"></i></a>
<a href='DeletePayment.php?id=<?php echo $row['PID']; ?>' data-bs-toggle="tooltip" title="Delete" data-bs-placement="bottom"><i class="fa fa-trash" id="u"></i></a>
...
<a type="button" class="btn btn-primary" href='DeletePayment.php?id=<?php echo $row['PID']; ?>' data-bs-toggle="tooltip" title="Delete" data-bs-placement="bottom">Delete</a>
      </div>
    </div>
  </div>
</div>
