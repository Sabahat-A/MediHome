...
include 'config.php';
$PID=mysqli_real_escape_String($conn,$_POST['ShopID']);
...
<form action="<?PHP $_SERVER['PHP_SELF'];?>"  method="POST" autocomplete="off" id="inserted" 
 ...
 <div class="row">
    <div class="col">
<input type="hidden" class="form-control" placeholder="ID" name="ShopID" value="<?php echo $row['PID'];?>" required/>
 ...
 <div class="row">
    <div class="col">
      ...
      <input type="text" class="form-control"  name="ShopName" placeholder="ShopName" value="<?php echo $row['ShopName'];  ?>" readonly required/>
    </div>
