...
<td>
 <a href='UpdateStore.php?id=<?php echo $row['ShopID']; ?>' data-bs-toggle="tooltip" title="Update" data-bs-placement="bottom"><i class=" fa fas fa-edit " id="u"></i></a>
<a href='DeleteStore.php?id=<?php echo $row['ShopID']; ?>' data-bs-toggle="tooltip" title="Delete" data-bs-placement="bottom"><i class="fa fa-trash" id="u"></i></a>
