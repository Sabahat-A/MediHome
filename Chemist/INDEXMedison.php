...
<p id="h11" class="h3 d-flex justify-content-center m-0 p-0"> MEDISON DETAILS</p>
</div> </div>
...
include 'config.php';
 $n=1;
$sql="select * from addmedison   where ShopName='$ShopName'  ORDER BY IDMED DESC";
...
<td><?php echo $row['MedisonDescription']; ?></td>
<td><?php echo $row['MedisonQty']; ?></td>
...
<td>
 <a href='UpdateMedison.php?id=<?php echo $row['IDMED']; ?>' data-bs-toggle="tooltip" title="Update" data-bs-placement="bottom"><i class=" fa fas fa-edit " id="u"></i></a>
<a href='DeleteMEDISON.php?id=<?php echo $row['IDMED']; ?>' data-bs-toggle="tooltip" title="Delete" data-bs-placement="bottom"><i class="fa fa-trash" id="u"></i></a>
