...
$sql = "SELECT ShopName FROM  payment WHERE ShopName = '{$ShopName}'";
    $result = mysqli_query($conn, $sql) or die("Query Failed.");
    
    if(mysqli_num_rows($result) > 0){
      $_SESSION['status']="YOU CAN ADD ONLY ONE Payment Method";
  
      }
   
else{
   $sql1 ="INSERT INTO payment (ShopName,Image)
 VALUES('{$ShopName}','{$new_img_name}')";
...
<p id="h11" class="h3 d-flex justify-content-center mt-4 p-0">ADD PAYMENT METHOD</p>
</div> </div> 
<div  class="">
...
<form action="<?PHP $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data" method="POST" class="col-md-12" autocomplete="off">       
 ...
 <div class="row">
    <div class="col">
      ...
      <input type="text" class="form-control"  name="ShopName" placeholder="ShopName"  value="<?php echo $ShopName ?>" required/>
    </div>
...
<div class="row">
    ...
    <div class="col">
    <div class="mb-3 mt-1">
      <small>Select QRCODE IMAGE :</small>
