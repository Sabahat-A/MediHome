...
<p id="h11" class="h3 d-flex justify-content-center m-0 p-0"> Appointment DETAILS</p>
</div> </div>
...
include 'config.php';
 $n=1;
$sql="select * from  appointment   where Email='$Email'  ORDER BY AID ";
...
<td>
 <a href='UpdateAppointment.php?id=<?php echo $row['AID']; ?>' data-bs-toggle="tooltip" title="Update" data-bs-placement="bottom"><i class=" fa fas fa-edit " id="u"></i></a>
<a href='DeleteAppointment.php?id=<?php echo $row['AID']; ?>' data-bs-toggle="tooltip" title="Delete" data-bs-placement="bottom"><i class="fa fa-trash" id="u"></i></a>
...
<a type="button" class="btn btn-primary" href='DeleteAppointment.php?id=<?php echo $row['AID']; ?>' data-bs-toggle="tooltip" title="Delete" data-bs-placement="bottom">Delete</a>
      </div>
    </div>
  </div>
</div>
